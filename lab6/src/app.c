...
void APP_USBDeviceEventHandler(USB_DEVICE_EVENT event, void * eventData, uintptr_t context)
{
    ...
    switch(event)
    {
        ...
        case USB_DEVICE_EVENT_DECONFIGURED:
            ...
            appData.emulateMouse = false;       //doesn't start drawing immediately
...
void APP_Tasks ( void )
{
    ...
    int8_t dir_table[] ={-4,-4,0, 0, 4, 4, 0, 0};
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)
                {
                    if (vector >= 9){
                        ...
                        appData.mouseButton[0] = MOUSE_BUTTON_STATE_PRESSED;    //Press down left click
                    }
