...
#ifndef _SHIRO019_ACCELEROMETER_SPI_H    /* Guard against multiple inclusion */
#define _SHIRO019_ACCELEROMETER_SPI_H 
...
#endif /* _SHIRO019_ACCELEROMETER_SPI_H  */
